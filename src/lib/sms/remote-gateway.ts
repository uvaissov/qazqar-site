...
//
// Коды пульта (проверено на машине 2026-09-14): «10» — снять с охраны и открыть
// замки, «11» — поставить на охрану и закрыть. Пульт отвечает SMS со статусом,
// но эта прошивка TG100 входящие SMS не принимает вовсе (ни в Inbox, ни в AMI),
// поэтому подтверждение по ответу не ждём — успех = шлюз принял SMSCommand.
